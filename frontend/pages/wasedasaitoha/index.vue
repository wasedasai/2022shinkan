...
export default {
  head: {
    title: '早稲田祭とは',
    meta: [
      { hid: 'description', name: 'description', content: '早稲田祭の歴史、規模、当日の様子が掲載されています' },
      { hid: 'keyword', name: 'keyword', content: '新歓、早稲田祭運営スタッフ、運スタ、早稲田、早稲田大学、早稲田祭' },
      { hid: 'og:type', property: 'og:type', content: 'article' },
      { hid: 'og:title', property: 'og:title', content: '早稲田祭とは' },
      { hid: 'og:description', property: 'og:description', content: '早稲田祭の歴史、規模、当日の様子が掲載されています' },
...
<template>
  <main>
    <div class="hero-wrapper">
      <OrganismsHero>早稲田祭とは</OrganismsHero>
    </div>
    <section class="history-section">
      <div class="section-inner">
        ...
        <div class="box">
          ...
          <div class="item">
            <div>2000年</div>
            <div>早稲田祭したくスタッフ結成</div>
          </div>
          <div class="item">
            <div><strong>2002年</strong></div>
            <div><strong>早稲田祭運営スタッフ結成</strong></div>
          </div>
          <div class="item">
            <div>2019年</div>
            <div>わせだサイくん誕生</div>
      ...
      <div class="section-inner">
        <div class="box">
          ...
          <div class="item">
            <h2>企画数</h2>
            <p>オフライン開催</p>
            <p class="number">約450企画</p>
            <p>オンライン開催</p>
            <p class="number">約300企画</p>
          </div>
          <div class="item">
            <h2>運営予算規模</h2>
            <p>オフライン開催</p>
            <p class="number">約3800万円</p>
            <p>オンライン開催</p>
            <p class="number">約2000万円</p>
          </div>
        </div>
      </div>
    </section>
